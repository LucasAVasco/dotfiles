return {
	...
	},
	{
		...
		config = function()
			...
			-- Command to set the current buffer database
			vim.api.nvim_create_user_command('DBUISetBufferCompletion', function()
				...
				vim.ui.select(open_conn_list, {
					...
					vim.notify(
						'The selected connection does not exist in the DBUI connection list: ' .. selected_item,
